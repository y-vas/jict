# -*- coding: utf-8 -*-
#
# jict documentation build configuration file, created by
...
latex_documents = [
  (master_doc, 'jict.tex', u'nested\\_dict Documentation',
...
man_pages = [
    (master_doc, 'jict', u'jict Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'jict', u'jict Documentation',
   author, 'jict', 'One line description of project.',
   'Miscellaneous'),
]
